...
import {
  ...
  testPushNotificationVendors,
  testPushNotificationDeliveryPartners,
...
router.post("/test-push-notification-vendors", testPushNotificationVendors);
router.post(
  "/test-push-notification-delivery-partners",
  testPushNotificationDeliveryPartners
);
